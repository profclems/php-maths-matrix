...
$Matrix = new Matrix;
$Matrix->displayAs("matrix"); //Display the results as matrix just to beautify for testing purposes. Default Option is array...
...
$Matrix = new Matrix;
$Matrix->displayAs("matrix"); //Display the results as matrix just to beautify for testing purposes. Default Option is array...
$resultingMatrix = $Matrix->add($matrix2, $matrix3);
echo $resultingMatrix;
</pre>
			</div>
		</div>
...
$Matrix = new Matrix;
$Matrix->displayAs("matrix"); //Display the results as matrix just to beautify for testing purposes. Default Option is array...
$resultingMatrix = $Matrix->subtract($matrix2, $matrix3);
echo $resultingMatrix;
</pre>
			</div>
		</div>
...
$Matrix = new Matrix;
$Matrix->displayAs("matrix"); //Display the results as matrix just to beautify for testing purposes. Default Option is array...
$resultingMatrix = $Matrix->multiply($matrix2, $matrix3);
echo $resultingMatrix;
</pre>
			</div>
		</div>
